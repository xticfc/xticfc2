...
<script type="text/javascript">
	$(document).ready(function(){
       $("#uploadify").uploadify({
	        ...
	        'uploader': '${ctx}/report/add?clientType=web',//服务器URL.本参数不可省略
	        ...
	        'onUploadStart' : function(file) {//在文件被上传前触发
	        	$("#uploadify").uploadify("settings", "formData", {'name':$("#name").val(),'dbname':$("#dbname").val(),'code':$("#code").val(),'period':$("#period").val(),'zw':$("#zw").val(),'reportstyle':$("#reportstyle").val(),'status':$("#status").val(),'tempflag':'1'});
	        }
	  });
    });  
...
<div class="center_con">
    <div class="butSet">
        <h1 class="tm2">新增报表</h1>
    </div>
    <div class="tabCon">
    	<form action="${ctx }/report/add?clientType=web" id="form1" method="post">
	        <table width="100%" class="bus_table"  border="0" cellspacing="0" cellpadding="0">
	            <tr>
	                <td  class="busTd_l">名称：</td>
	                <td class="busTd_r"><input name="longName" id="name" type="text" class="input1" datatype="*"  /></td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	            <tr>
	                <td  class="busTd_l">对应表名：</td>
	                <td class="busTd_r"><input name="dbtable"  id="dbname" type="text" class="input1"   /></td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	            <tr>
	                <td  class="busTd_l">表编码：</td>
	                <td class="busTd_r"><input name="code" id="code" type="text" class="input1" datatype="s6-6"  /></td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	            <tr>
	                ...
	                <td class="busTd_r">
	                	<select class="select1" name="period" id="period">
	                        ...
	                        <option value="1"  >侯报</option>
	                        <option value="2" >周报</option>
	                        <option value="3" >月报</option>
	                        <option value="4" >年报</option>
	                        <option value="5"  >单次报表</option>
	                        <option value="6" >旬报表</option>
	                    </select>
	                </td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	            <tr>
	                ...
	                <td class="busTd_r">
						<select class="select1" name="zwId" id="zw">
	                		<option value="04" >棉花</option>
	                        <option value="03" >水稻</option>
	            ...
	            <tr>
	                ...
	                <td class="busTd_r">
	                	<select class="select1" name="reportStyle" id="reportstyle">
	                		<option value="1" >单记录表</option>
	                        <option value="2">多记录表</option>
	                    </select>
	                </td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	            ...
	            <tr>
	                ...
	                <td class="busTd_r" colspan="2">
	                    <div class="busb_l"><a href="#" id="" onclick="uploadfile()" class="save"></a></div>
