    ...
    <div class="tabCon">
    	<form action="${ctx }/mmsUser/add" id="form1" method="post">
	        ...
	        <tr>
	                ...
	                <td class="busTd_r"><input id="name" name="name" type="text" readonly="readonly" onclick="showMenu();" class="input1" datatype="*"/>
	            ...
	            <tr>
	                ...
	                <td class="busTd_r"><input name="mobile" type="text" class="input1" /></td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	           <tr>
	                <td  class="busTd_l">设备串号：</td>
	                <td class="busTd_r"><input name="mobileId" type="text" class="input1" datatype="*"/></td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	            <tr>
	                <td  class="busTd_l">SIM卡号：</td>
	                <td class="busTd_r"><input name="simId" type="text" class="input1" /></td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	             <tr>
	            	<td  class="busTd_l">是否有效：</td>
	                <td class="busTd_r">
	            ...
	            <tr>
	                ...
	                <td class="busTd_r"><input name="equipment" type="text" class="input1" /></td>
	                <td ><div class="Validform_checktip"></div></td>
	            </tr>
	            <tr>
	                <td  class="busTd_l"></td>
